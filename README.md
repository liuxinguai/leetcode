...
> 二叉数Morris：先序、中序、后续遍历

1. 先序遍历：在节点第一次出现在Mirrors遍历中就打印，第二次出现不处理
2. 中序遍历：在节点（该节点会在Mirrors遍历中出现两次）第二次出现时打印，在节点当且仅当会出现一次时就打印
3. 后序遍历：在节点第二次出现时，逆序打印该节点的左子树的右边树，直至mirrors遍历完成后，最后逆序打印树的右边界
